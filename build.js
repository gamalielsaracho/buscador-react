...
var _componentsSearchExample = require('./components/SearchExample');

var _componentsSearchExample2 = _interopRequireDefault(_componentsSearchExample);

_superagent2['default'].get('http://jsonplaceholder.typicode.com/posts').end(function (error, data) {
	if (!error && data) {
		var url = data.body;
		_react2['default'].render(_react2['default'].createElement(_componentsSearchExample2['default'], { apiUrl: url }), document.getElementById('container'));
	} else {
		console.log(error);
	}
});

},{"./components/SearchExample":2,"react":159,"superagent":161}],2:[function(require,module,exports){
'use strict';
...
var SearchExample = (function (_React$Component) {
	...
	function SearchExample(props) {
		...
		_get(Object.getPrototypeOf(SearchExample.prototype), 'constructor', this).call(this, props);
